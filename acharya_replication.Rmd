...
# For the second column of the data is uses the columns dem, pslave1860, and state.abb
...
# For the third column I found the same thing to be true:
...
summary(cnty.res.full, terms = "r.squared")
